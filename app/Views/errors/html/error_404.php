        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <p>
                        Halaman yang Anda akses tidak tersedia atau telah dipindahkan. Silakan kembali ke halaman utama melalui tombol di bawah ini.
                    </p>
                    <button class="btn green" onclick="window.location.href='<?= base_url() ?>'">Beranda</button>
                </div>
            </div>
        </div>
    </main>
