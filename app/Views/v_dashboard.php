...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    try {
      ...
      console.log("Labels:", <?= json_encode($bulan_labels2); ?>);
      console.log("Datasets:", <?= json_encode($data_grafik2); ?>);
      ...
      // Gunakan sintaks Chart.js v2.x (sesuai dengan kode yang berhasil)
      myBarChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: <?= json_encode($bulan_labels2); ?>,
          datasets: <?= json_encode($data_grafik2); ?>
        },
        options: {
          maintainAspectRatio: false,
          layout: {
  ...
  // Fungsi updateChartPerawatan juga perlu disesuaikan
