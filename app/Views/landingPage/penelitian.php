        ...
        <div class="row">
            ...
            <div class="col-lg-8 posts-list">
                <div class="single-post">
                    ...
                    <?php if (!empty($_GET['instansi']) || !empty($_GET['tahun'])): ?>
                                ...
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="card-meta d-flex align-items-center mb-3">
                                            <span class="text-muted"><i class="far fa-calendar-alt me-1"></i> <?= date('d F Y', strtotime($p['tanggal_penelitian'])); ?></span>
                                        </div>
                                        <div class="researcher-info p-3 bg-light rounded">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="mb-1"><i class="fas fa-calendar-day me-2"></i> <strong>Tahun:</strong>
                                                        <a href="<?= base_url('penelitian?tahun=' . date('Y', strtotime($p['tanggal_penelitian']))); ?>" class="text-decoration-none">
                                                            <?= date('Y', strtotime($p['tanggal_penelitian'])); ?>
                                                        </a>
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <li class="media mb-1 pb-1">
                                        <div class="media-body">
                                            ...
                                            <small class="text-muted">
                                                <i class="far fa-calendar-alt me-1"></i> <?= date('d F Y', strtotime($p['tanggal_penelitian'])); ?>
                                            </small>
                                        </div>
                                    </li>
                                <?php endforeach; ?>
