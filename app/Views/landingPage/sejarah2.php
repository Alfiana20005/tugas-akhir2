				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="/home">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="/sejarah2"> Sejarah</a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 insurence-right">
                            ...
                            <div class="list-wrap">
								<ul>
									<li>Museum Negeri Nusa Tenggara Barat mulai dirintis melalui Proyek Rehabilitasi dan Perluasan Museum pada tahun 1976.</li>
									</ul>
							</div>
                            <h3>1982</h3>
                            <div class="list-wrap">
								<ul>
									<li>Museum Negeri Nusa Tenggara Barat
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 insurence-left">
                            ...
                            <div class="list-wrap">
								<ul>
									<li>Museum Negeri Nusa Tenggara Barat menjadi UPT (Unit Pelaksana Teknis) Diktorat Jenderal Kebudayaan.
                                </li></ul>
							</div>
							<h3>2000-2016</h3>
                            <div class="list-wrap">
...
Provinsi Nusa Tenggara Barat.
                            ...
                            <div class="list-wrap">
								<ul>
									<li>Sejak tanggal 1 Januari 2017, Museum
