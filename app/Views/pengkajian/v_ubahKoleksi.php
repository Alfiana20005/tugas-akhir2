                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                            <select class="form-select form-control" type="text" name="lemari" value="<?= $data_koleksi['lemari']; ?>">
                                ...
                                <option <?= $data_koleksi['lemari'] == 'Lemari 11'? 'selected' : 'Lemari 11' ?> value="Lemari 11">Lemari 11</option>
                                <option <?= $data_koleksi['lemari'] == 'Lemari 12'? 'selected' : 'Lemari 12' ?> value="Lemari 12">Lemari 12</option>
