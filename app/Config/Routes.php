...
$routes->get('/ketentuan-lomba-melukis-caping-2026', 'C_LandingPage::ketentuanLombaMelukisCaping');
$routes->get('/ketentuan-lomba-ethnic-dance-2026', 'C_LandingPage::ketentuanLombaEthnicDance');
$routes->get('/ketentuan-lomba-got-talent-2026', 'C_LandingPage::ketentuanLombaGotTalent');
$routes->get('/ketentuan-lomba-mewarnai-2026', 'C_LandingPage::ketentuanMewarnai');
$routes->get('/ketentuan-lomba-museum-begawe-2026', 'C_LandingPage::ketentuanMuseumBegawe');
